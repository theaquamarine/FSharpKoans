...
module ``about the stock example`` =
    ...
    let YouGotTheAnswerCorrect() =
        ...
        let dayVariance x =
            ...
            let dayOpen = System.Double.Parse split.[1]
            let dayClose = System.Double.Parse split.[4]
            abs (dayOpen - dayClose)
        let maxDay = List.maxBy dayVariance (List.tail stockData)
        let result = (splitCommas maxDay).[0]
